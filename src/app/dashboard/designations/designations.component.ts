...
export class DesignationComponent implements OnInit {
 ...
 designation : Designation;
  ...
  addDesig(designation:Designation) {
  ...
  EditDesig(i: number, Id: number, Code: string, Name: string, Description: string) {
    this.id = Id;
  ...
  deleteDeig(i: number, Id: number, Code: string, Name: string, Description: string) {
     this.index = i;
     this.id = Id;
...
export class ExampleDataSource extends DataSource<Designation> {
  ...
  connect(): Observable<Designation[]> {
    ...
    this._exampleDatabase.getAllDesignations();

    return Observable.merge(...displayDataChanges).map(() => {
      // Filter data
      this.filteredData = this._exampleDatabase.Groupdata.slice().filter((designation: Designation) => {
        const searchStr = (designation.Id + designation.Code + designation.Name + designation.Description ).toLowerCase();
  ...
  sortData(data: Designation[]): Designation[] {
