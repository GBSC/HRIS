...
import { DeleteDepartmentComponent } from './dialogs/delete/delete.component';
...
export class DepartmentComponent implements OnInit {
  ...
  addNewDep(department: Department) {
  ...
  startEdit(i: number, Id: number, Code: string, Name: string, Description: string) {
    ...
    const dialogRef = this.dialog.open(EditDepDialogComponent, {
  ...
  deleteDepartment(i: number, Id: number, Code: string, Name: string, Description: string) {
    this.index = i;
    this.id = Id;
...
export class ExampleDataSource extends DataSource<Department> {
  ...
  connect(): Observable<Department[]> {
    ...
    return Observable.merge(...displayDataChanges).map(() => {
      // Filter data
      this.filteredData = this._exampleDatabase.depdata.slice().filter((department: Department) => {
        const searchStr = (department.Id + department.Name + department.Code).toLowerCase();
