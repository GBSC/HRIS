...
import { DeleteQualificationComponent } from './dialogs/delete/delete.component';
...
export class QualificationComponent implements OnInit {
  ...
  addNew(qualification: Qualification) {
    const dialogRef = this.dialog.open(QualificationAddDialogComponent, {
  ...
  startEdit(i: number, Id: number, Code: string, Name: string, Description: string) {
    ...
    const dialogRef = this.dialog.open(QualificationEditComponent, {
  ...
  deleteQualification(i: number, Id: number, Code: string, Name: string, Description: string) {
    this.index = i;
    this.id = Id;
...
export class ExampleDataSource extends DataSource<Qualification> {
  ...
  connect(): Observable<Qualification[]> {
    ...
    this._exampleDatabase.getAllqualifications();

    return Observable.merge(...displayDataChanges).map(() => {
      // Filter data
      this.filteredData = this._exampleDatabase.qualificationdata.slice().filter((qualification: Qualification) => {
        const searchStr = (qualification.Id + qualification.Name + qualification.Code).toLowerCase();
