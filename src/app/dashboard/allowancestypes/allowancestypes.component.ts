...
export class AllowancesTypeComponent implements OnInit {
  ...
  addAllowances(AllowancesType:AllowancesType) {
    const dialogRef = this.dialog.open(AddAllowancesTypeComponent, {
      data: {AllowancesType: AllowancesType }
    });
  ...
  EditAllowances(i: number, Id: number, Code: string, Name: string, Description: string) {
    this.id = Id;
    // index row is used just for debugging proposes and can be removed
    this.index = i;
    console.log(this.index);
    const dialogRef = this.dialog.open(EditAllowancesTypeComponent, {
  ...
  deleteAllowances(i: number, Id: number, Code: string, Name: string, Description: string) {
     this.index = i;
     this.id = Id;
     const dialogRef = this.dialog.open(DeleteAllowncesTypeComponent, {
       data: {Id: Id,Code:Code, Name: Name, Description: Description}
     });
...
export class ExampleDataSource extends DataSource<AllowancesType> {
  ...
  filteredData: AllowancesType[] = [];
  renderedData: AllowancesType[] = [];
  ...
  connect(): Observable<AllowancesType[]> {
    ...
    this._exampleDatabase.GetAllAllowancesType();

    return Observable.merge(...displayDataChanges).map(() => {
      // Filter data
      this.filteredData = this._exampleDatabase.AllowancesTypedata.slice().filter((AllowancesType: AllowancesType) => {
        const searchStr = (AllowancesType.Id + AllowancesType.Code + AllowancesType.Name + AllowancesType.Description ).toLowerCase();
  ...
  sortData(data: AllowancesType[]): AllowancesType[] {
