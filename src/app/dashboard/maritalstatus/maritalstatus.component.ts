...
export class MaritalStatusComponent implements OnInit {
  ...
  addNew(maritalstatus: MaritalStatus) {
    const dialogRef = this.dialog.open(MaritalAddDialogComponent, {
  ...
  startEdit(i: number, Id: number, Code: string, Name: string, Description: string) {
    ...
    const dialogRef = this.dialog.open(MaritalEditDialogComponent, {
  ...
  deleteMstatus(i: number, Id: number, Code: string, Name: string, Description: string) {
    this.index = i;
    this.id = Id;
    const dialogRef = this.dialog.open(DeleteMstatusComponent, {
      data: {Id: Id,Code:Code, Name: Name, Description: Description}
    });
...
export class ExampleDataSource extends DataSource<MaritalStatus> {
  ...
  connect(): Observable<MaritalStatus[]> {
    ...
    this._exampleDatabase.getAllMaritalStatus();

    return Observable.merge(...displayDataChanges).map(() => {
      // Filter data
      this.filteredData = this._exampleDatabase.maritalstatusdata.slice().filter((maritalstatus: MaritalStatus) => {
        const searchStr = (maritalstatus.Id + maritalstatus.Name + maritalstatus.Code).toLowerCase();
  ...
  sortData(data: MaritalStatus[]): MaritalStatus[] {
